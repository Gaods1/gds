...
# 项目立项审核
router.register(r'project_cer', ProjectCommonCheckInfoViewSet)
# 项目上传合同审核
router.register(r'project_upcontract_cer', ProjectCommonCheckInfoViewSet)
# 项目标书审核
router.register(r'project_bid_cer', ProjectCommonCheckInfoViewSet)
# 项目固化审核
router.register(r'project_solid_cer', ProjectCommonCheckInfoViewSet)
# 项目终止审核
