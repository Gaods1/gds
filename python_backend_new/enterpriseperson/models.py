...
class  PersonalInfo(models.Model):
    ...
    state = models.IntegerField(verbose_name='状态',default=2,blank=True,null=True)
...
class EnterpriseBaseinfo(models.Model):
    ...
    business_license = models.CharField(verbose_name='营业执照',max_length=64,validators=[validate_license],unique=True,default=None)
    ...
    etel = models.CharField(verbose_name='企业电话',max_length=16,validators=[validate_tel],blank=True,null=True)
    ...
    eemail = models.CharField(verbose_name='企业邮箱',max_length=64,  validators=[validate_email],blank=True,null=True)
    addr = models.CharField(verbose_name='企业地址',max_length=255,blank=True,null=True)
    zipcode = models.CharField(verbose_name='企业邮编',max_length=8,validators=[validate_zipcode],blank=True,null=True)
    elevel = models.IntegerField(verbose_name='业务能力评级(1-5)',default=1,blank=True,null=True)
    credi_tvalue = models.IntegerField(verbose_name='企业信用值(0-100)',default=0,blank=True,null=True)
    ...
    account_code = models.CharField(verbose_name='关联帐号',blank=True,null=True, max_length=64,unique=True,default=None)
