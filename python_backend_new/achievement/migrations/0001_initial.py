...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Requirement_Broker_Info',
            fields=[
                ('serial', models.AutoField(primary_key=True, serialize=False)),
                ('trace_code', models.CharField(blank=True, default=misc.misc.gen_uuid32, max_length=64, null=True)),
                ('rcode', models.CharField(blank=True, max_length=64, null=True)),
                ('bcode', models.CharField(blank=True, max_length=64, null=True)),
                ('state', models.IntegerField(blank=True, null=True)),
                ('creater', models.CharField(blank=True, max_length=64, null=True)),
                ('insert_time', models.DateTimeField(auto_now_add=True, null=True)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('check_time', models.DateTimeField(auto_now_add=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cooperation_name', models.CharField(blank=True, max_length=64, null=True)),
                ('state', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('serial', models.AutoField(primary_key=True, serialize=False)),
                ('a_code', models.CharField(blank=True, default=misc.misc.gen_uuid32, max_length=64, null=True)),
                ('rr_code', models.CharField(blank=True, max_length=64, null=True)),
                ('account_code', models.CharField(blank=True, max_length=64, null=True)),
                ('state', models.IntegerField(blank=True, null=True)),
                ('apply_time', models.DateTimeField(auto_now_add=True, null=True)),
